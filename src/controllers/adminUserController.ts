...
export const getUsers = async (req: any, res: Response) => {
    try {
        const {
            ...
            sortBy = 'createdAt',
            sortOrder = 'desc',
            cursor: _, // For cursor-based pagination (optional implementation)
        } = req.query;
        ...
        return handleControllerError(res, error, 'GetUsers');
    }
};
...
export const bulkUserAction = async (req: any, res: Response) => {
    try {
        ...
        return res.json({ message: 'Bulk action completed', count: result.count });

    } catch (error) {
        return handleControllerError(res, error, 'BulkUserAction');
    }
};
...
export const exportUsers = async (_req: any, res: Response) => {
    try {
        ...
        return handleControllerError(res, error, 'ExportUsers');
    }
};
